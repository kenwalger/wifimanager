...
BasicManager.prototype.createAdHocNetwork = function (ssid, wpa_passphrase) {
    ...
    fs.writeFile("/etc/hostapd/hostapd.conf",
        ...
        function (err)  {
            ...
            console.log("\n[WIFIMANAGER] hostapd.conf was successfully saved.");
    ...
    console.log("[WIFIMANAGER] Attempting to start HOSTAPD service for network " + ssid + ".".blue);
    ...
    console.log("[WIFIMANAGER] Attempting to start UDHCPD service.".blue);
