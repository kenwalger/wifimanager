...
BasicManager.prototype.isConnected = function(interface) {
    var connectionState = require('child_process').exec;
    var interfaceConnectionState = '';
    interface = interface || 'wlan0';
    var cmd = 'cat /sys/class/net/' + interface + '/operstate';
    connectionState(cmd, function( error, stdout, stderr) {
    ...
    interfaceConnectionState = connectionState(interface);
