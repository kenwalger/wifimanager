...
/**
 * interfaceConnectionState() checks the status of the wireless network adapter
...
BasicManager.prototype.interfaceConnectionState = function (lanInterface) {

	lanInterface = lanInterface || 'wlan0';
	interfaceConnectionState = '';
	var cmd = 'cat /sys/class/net/' + lanInterface + '/operstate';
	var connectionState = require('child_process').execSync;
	return connectionState(cmd);
};
